...
exports.addSubscriptionPlan = async (req, res) => {
  try {
    ...
    res
      ...
      .send({
        status: false,
        message: "Subscription Plan cannot be added,an error occurred.",
        data: [],
        error: err.message,
      });
  }
...
exports.listSubscriptionPlan = async (req, res) => {
  try {
    ...
    res
      ...
      .send({
        status: true,
        message: "Subscription plan listed successfully.",
        data: listPlan,
      });
  } catch (err) {
    console.log(err);
    res
      ...
      .send({
        status: false,
        message: "Subscription Plan cannot be listed, an error occurred.",
        data: [],
        error: err.message,
      });
  }
  ...
  try {
    ...
    if (getPlan)
      return res
        ...
        .send({
          status: true,
          message: "Subscription plan geted successfully.",
          data: getPlan,
        });
    else
      return res
    ...
    res
      ...
      .send({
        status: false,
        message: "Subscription plan cannot be get, an error occurred.",
        data: [],
        error: err.message,
      });
  }
...
exports.updateSubscriptionPlan = async (req, res) => {
  try {
    ...
    if (isValid.isTrue) {
      ...
      const updateData = await Models.SubscriptionPlans.update(planInfo, {
        where: { id: id },
      });
      res
        .status(200)
...
exports.deleteSubscriptionPlan = async (req, res) => {
  try {
    const { id } = req.params;
    const deleteData = await Models.SubscriptionPlans.destroy({
      where: { id: id },
    });
    res
      .status(200)
    ...
    res
      ...
      .send({
        status: false,
        message: "Subscription plan cannot be deleted, an error occurred.",
        data: [],
        error: err.message,
      });
  }
...
exports.userSubscriptionHistory = async (req, res) => {
  try {
    ...
    res
      ...
      .send({
        status: false,
        message: "An error occurred while fecthing Subscription History.",
        data: [],
        error: err.message,
      });
  }
...
exports.updatePlanStatus = async (req, res) => {
  try {
    ...
    const updateStatus = await Models.SubscriptionPlans.update(
      { status },
      { where: { id } }
    );
    const listPlan = await Models.SubscriptionPlans.findAll({
