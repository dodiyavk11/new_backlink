                  ...
                  <table className="table">
                    <tbody>
                      <tr>
                        ...
                        <td className="text-end-ct">{orderData.anchortext}</td>
                      </tr>
                      <tr>
                        <td>
                          Delivery time
                      ...
                      <tr>
                        ...
                        <td className="text-end-ct">{domainData.attribute}</td>
                      </tr>
                      <tr>
                        <td>
                          Language
                        ...
                        <td className="text-end-ct">
                          {domainData.language === "en" ? "English" : "German"}
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        {/* <td colSpan={2} className="text-center">
                          ...
                          <div className="btn-group-md">
                            <button
                              ...
                              onClick={() =>
                                this.handleAddtoCart(orderData.hash_id)
                              }
                              style={{ width: "100%" }}
                            >
                              Add to cart
