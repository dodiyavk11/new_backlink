  ...
  handleRadioChange = (value) => {
    this.setState(
      ...
      () => {
        ...
        // Call the updateCartItem function here
        this.props.updateCartItem(this.props.item, {
          textCreation: this.state.textCreation,
          wordCount: this.state.wordCount,
          // Add other properties as needed
        });
        console.log("State values after updateCartItem:", this.state);
      }
    );
  };
//   handleRadioChange = (value) => {
...
//       }
//     );
//     console.log(this.props.updateCartItem)
//   };
    ...
    return (
      <Form>
        ...
        <div className="modal1">
          <div className="row">
            <div className="col-sm-12">
              ...
              <p className="customText mb-0">Who should write your content?</p>
            </div>
          </div>
          ...
          <div className="w-full border mb-4 p-3 rounded mt-2">
            <div>
              <span>This publisher accepts websites from any subject area</span>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
              <label className="mb-0">Word count</label>
              <p className="customText mb-0">How long should the article be?</p>
            </div>
          </div>
          <div
          ...
          >
            <div>
              ...
              >
                ...
                ></i>{" "}
                500 Words <span className="float-right fontBold500">Free</span>
              </label>
            </div>
            <div>
              <label
              ...
              >
                ...
                ></i>{" "}
                1000 Words <span className="float-right fontBold600">+$50</span>
              </label>
            </div>
          </div>
          <div
          ...
          >
            <div className="d-flex justify-content-between">
              ...
              <div>
                <span style={{ color: "#ff9756" }} className="fontBold700 mr-2">
                  NEW
                </span>
        ...
        <div className="modal2">
          ...
          <div className="row mt-3">
            <div className="col-sm-12">
              <label htmlFor="anchortext">
                Anchor text*
                <p className="customText mb-0">
                  Specify which anchor text to use. How to choose your anchor
                  text correctly, you will learn here Nontheless, the publisher
                  has the final say in the anchor text selection.
                </p>
              </label>
          ...
          {/* <button
            className="btn btn-rounded btn-lg font-weight-medium mt-2"
